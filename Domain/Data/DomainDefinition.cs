    ...
    public class DomainDefinition
    {
        ...
        static DomainDefinition()
        {
            ...
            foreach (var section in IniFile.GetSectionNames(iniFile))
            {
                ...
                define.HEDROffset = int.Parse(GetValue(values, "HEDROffset", "4"), System.Globalization.CultureInfo.InvariantCulture);
                define.HEDRRecSize = int.Parse(GetValue(values, "HEDRRecSize", "2"), System.Globalization.CultureInfo.InvariantCulture);
                define.RecSize = int.Parse(GetValue(values, "RecSize", "16"), System.Globalization.CultureInfo.InvariantCulture);
