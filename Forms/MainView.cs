...
namespace TESsnip {
    ...
    internal partial class MainView : Form {
        ...
        private void listView1_SelectedIndexChanged(object sender, EventArgs e) {
            ...
            var selNode = listView1.SelectedItems[0];
            SubRecord sr=(SubRecord)selNode.Tag;
            
            if(SubrecordStructs!=null&&SubrecordStructs[listView1.SelectedIndices[0]].elements!=null) {
                tbInfo.Text = sr.GetFormattedData(SubrecordStructs[listView1.SelectedIndices[0]], LookupFormIDI, LookupFormStrings);
            } else {
        ...
        private void listView1_ItemActivate(object sender, EventArgs e) {
            ...
            if(useNewSubrecordEditorToolStripMenuItem.Checked&&SubrecordStructs!=null&&SubrecordStructs[listView1.SelectedIndices[0]].elements!=null&&
                ...
                try {
                    re = new MediumLevelRecordEditor(sr, SubrecordStructs[listView1.SelectedIndices[0]], LookupFormIDS, FormIDScan, LookupFormStrings);
                } catch {
